...
* **JDK 17** (required by the current Gradle/Android Gradle Plugin setup)
...
> Note: If Java 21+ is active, Gradle 7.4 in this project can fail with `Unsupported class file major version` during build script evaluation.
